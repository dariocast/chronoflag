...
export interface Snapshot{id:string;title?:string;view_token?:string;tier:'free'|'premium';lifecycle:'active'|'archived';clocks:Clock[];highlighted_clock_id?:string;version:number;last_control_at:string;server_time:string}
